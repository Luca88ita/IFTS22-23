...
for (let index = 0; index < 4; index++) {
  ...
  linkedButton.style.transition = "1000ms";
  linkedButton.addEventListener("mouseover", () => {
    linkedButton.style.backgroundColor = "yellow";
    linkedButton.style.backgroundImage = "none";
  });
  linkedButton.addEventListener("mouseout", () => {
    linkedButton.style.backgroundColor = "white";
    linkedButton.style.backgroundImage = "url(./assets/rainbow.jpg)";
    linkedButton.style.backgroundSize = "cover";
    linkedButton.style.backgroundRepeat = "no-repeat";
  });
