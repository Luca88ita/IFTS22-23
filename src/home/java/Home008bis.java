...
public class Home008bis {
  ...
  public static void main(String[] args) {
    ...
    try (Scanner scn = new Scanner(System.in)) {
      ...
      // System.out.println("Il "+input+"° numero primo è
      // "+primeNumbersSearch2(input)[input-1]);
 ...
 * per farlo bisogna che mi salvo una lista con i numeri primi trovati a partire
 * da 2
 * il limite massimo della ricerca prima di essere sicuro che ho trovato un
 * numero primo, è sqrt(numero ricercato).
 * la ricerca stessa può essere limitata ai numeri dispari che non terminano con
 * 5
 */